        ...
        <header class="header-area clearfix">
            ...
            <nav class="amado-nav">
                <ul>
                    ...
                    <li class="active"><a href="merchandise_intro.jsp">MERCHANDISE</a></li>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                               ...
                               <form method="post" action="merchandise_check.jsp">
    							<h3 style="text-align: center;"> LOGIN</h3>
    							<div class="form-group">
     							<input type="text" class="form-control" placeholder="account" name="MerchandiseAccount" maxlength="20">
    							</div>

    			<div class="form-group">
     				<input type="password" class="form-control" placeholder="pin" name="MerchandisePIN" maxlength="20">
    			</div>
    			<input type="submit" class="btn amado-btn w-100" value="SUMBIT">
   					</form>
   					<br>
   					<input type="button" class="btn amado-btn w-100" value="AUTHENTICATION" onclick="location.href='authentication.jsp'">
                            </div>
