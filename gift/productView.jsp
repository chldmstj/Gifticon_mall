        ...
        <header class="header-area clearfix">
          ...
          <nav class="amado-nav">
                <ul>
                    ...
                    <li class="active"><a href="productView.jsp?Categorycode=1&Brandcode=1" accesskey="1" title="">Product</a></li>
   ...
   <div class="shop_sidebar_area">
            ...
            <div class="widget catagory mb-50">
                ...
                <div class="catagories-menu">
                    <ul>
                        <li class="active"><a href="productView.jsp?Categorycode=1&Brandcode=1" accesskey="1" title="">CAFE</a></li>
                        <li><a href="c_cinema.jsp?Categorycode=2&Brandcode=1" accesskey="2" title="">CINEMA</a></li>
                        <li><a href="c_restraurant.jsp?Categorycode=3&Brandcode=1" accesskey="3" title="">RESTAURANT</a></li>
...
for (int i = 0; i < list.size(); i++) {
	 ...
	 if ("1".equals(list.get(i).getCategoryCode())){
		
		 if("1".equals(list.get(i).getBrandCode())) image="img/product-img/starbuks.jpg";
		 else if("2".equals(list.get(i).getBrandCode()))  image="img/product-img/hollys.png";
		 else if("3".equals(list.get(i).getBrandCode()))  image="img/product-img/ediya.jpg";
		 else if("4".equals(list.get(i).getBrandCode()))  image="img/product-img/caffebene.png";
	name=list.get(i).getName();
	%>
		<div class="boxD" margin:auto;>
