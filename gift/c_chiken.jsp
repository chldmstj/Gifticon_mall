            ...
            <div class="widget catagory mb-50">
                ...
                <div class="catagories-menu">
                    <ul>
                        ...
                        <li class="active"><a href="c_chiken.jsp?Categorycode=5&Brandcode=1" accesskey="5" title="">CHICKEN</a></li>
...
for (int i = 0; i < list.size(); i++) {
	 ...
	 if ("5".equals(list.get(i).getCategoryCode())){
			
		 if("1".equals(list.get(i).getBrandCode())) image="http://www.techholic.co.kr/news/photo/201809/177983_142944_712.jpg";
		 else if("2".equals(list.get(i).getBrandCode()))  image="img/product-img/bbq.jpg";
