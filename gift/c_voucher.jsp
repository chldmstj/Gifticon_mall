            ...
            <div class="widget catagory mb-50">
                ...
                <div class="catagories-menu">
                    <ul>
                        ...
                        <li class="active"><a href="c_voucher.jsp?Categorycode=6&Brandcode=1" accesskey="6" title="">VOUCHER</a></li>
...
for (int i = 0; i < list.size(); i++) {
	 ...
	 if ("6".equals(list.get(i).getCategoryCode())){
			
		 if("1".equals(list.get(i).getBrandCode())) image="img/product-img/shinsegae.png";
		 else if("2".equals(list.get(i).getBrandCode()))  image="http://www.infostockdaily.co.kr/news/photo/201905/59262_16998_2931.jpg";
		 else if("3".equals(list.get(i).getBrandCode()))  image="";
