...
<body>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="single_product_desc">
                            ...
                            <div class="product-meta-data">
                                <div class="line"></div>
                                <p class="product-price">USER LOGIN</p><br><br>
    ...
    <div class="form-group">
     ...
     <input type="password" class="form-control" placeholder="PWD" name="userPassword" maxlength="20">

    </div>

    <input type="submit" class="btn amado-btn" value="SUMBIT">
