            ...
            <div class="widget catagory mb-50">
                ...
                <div class="catagories-menu">
                    <ul>
                        ...
                        <li class="active"><a href="c_cinema.jsp?Categorycode=2&Brandcode=1" accesskey="2" title="">CINEMA</a></li>
...
for (int i = 0; i < list.size(); i++) {
	 ...
	 if ("2".equals(list.get(i).getCategoryCode()))
	 {
		 else if("1".equals(list.get(i).getBrandCode()))  image="img/product-img/cgv.jpg";
		 else if("2".equals(list.get(i).getBrandCode()))  image="img/product-img/lotte.png";
		 else if("3".equals(list.get(i).getBrandCode()))  image="https://file.mk.co.kr/meet/neds/2016/05/image_readtop_2016_316409_14621501432455893.jpg";
		 else if("4".equals(list.get(i).getBrandCode()))  image="";
		 %>
