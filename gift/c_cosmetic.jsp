            ...
            <div class="widget catagory mb-50">
                ...
                <div class="catagories-menu">
                    <ul>
                        ...
                        <li class="active"><a href="c_cosmetic.jsp?Categorycode=4&Brandcode=1" accesskey="4" title="">COSMETIC</a></li>
...
for (int i = 0; i < list.size(); i++) {
	 ...
	 if ("4".equals(list.get(i).getCategoryCode())){
			
		 if("1".equals(list.get(i).getBrandCode())) image="img/product-img/oliveyoung.png";
		 else if("2".equals(list.get(i).getBrandCode()))  image="https://jpassets.jobplanet.co.kr/production/uploads/company/logo/332765/large_%EB%9E%84%EB%9D%BC%EB%B8%94%EB%9D%BC%EB%A1%9C%EA%B3%A0.png";
		 else if("3".equals(list.get(i).getBrandCode()))  image="img/product-img/lohbs.jpg";
		 %>
